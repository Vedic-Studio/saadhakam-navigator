...
18:["$","li","1",{"className":"flex gap-3","children":[["$","span",null,{"className":"w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-sm font-medium","children":2}],["$","span",null,{"className":"text-muted-foreground","children":"Advaita Vedanta as philosophical foundation"}]]}]
19:["$","li","2",{"className":"flex gap-3","children":[["$","span",null,{"className":"w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-sm font-medium","children":3}],["$","span",null,{"className":"text-muted-foreground","children":"Both karma (action) and jnana (knowledge) are valid paths"}]]}]
1a:["$","li","3",{"className":"flex gap-3","children":[["$","span",null,{"className":"w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-sm font-medium","children":4}],["$","span",null,{"className":"text-muted-foreground","children":"Flexibility in practice with orthodoxy in principle"}]]}]
