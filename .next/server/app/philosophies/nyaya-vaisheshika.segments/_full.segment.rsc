...
18:["$","li","1",{"className":"flex gap-3","children":[["$","span",null,{"className":"w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-sm font-medium","children":2}],["$","span",null,{"className":"text-muted-foreground","children":"Sixteen categories of logical analysis"}]]}]
19:["$","li","2",{"className":"flex gap-3","children":[["$","span",null,{"className":"w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-sm font-medium","children":3}],["$","span",null,{"className":"text-muted-foreground","children":"Atomic theory of material existence"}]]}]
1a:["$","li","3",{"className":"flex gap-3","children":[["$","span",null,{"className":"w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 text-sm font-medium","children":4}],["$","span",null,{"className":"text-muted-foreground","children":"Liberation through elimination of false knowledge"}]]}]
