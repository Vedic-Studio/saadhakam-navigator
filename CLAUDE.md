...
Source: Karpathy's 4 (Jan 2026) + 8 agent-orchestration rules tested across 30 codebases (May 2026, @Mnilax).
...
**Stay under 200 lines combined with project-specific rules. Past that, compliance drops sharply.**

Add project-specific rules below this line (stack, test commands, error patterns, deployment).
