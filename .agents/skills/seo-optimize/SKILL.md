...
4. **Read learnings**: If `.Codex/skills/debrief/learnings/seo-optimize/` exists, read the 5 most recent. Skip if empty or missing.
...
3-5 bullet points designed to be cited by AI engines (ChatGPT, Perplexity, Codex, Gemini). Each must be:
...
2. **If substantive changes** (FAQs rewritten, headings changed, links rejected):
   ...
   - If yes, save to `.Codex/skills/debrief/learnings/seo-optimize/` with date, article slug, and lesson
