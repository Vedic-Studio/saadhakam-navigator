...
1. **Read learnings**: If `.Codex/skills/debrief/learnings/idea-sourcer/` exists and has files, read the 5 most recent. Skip if empty or missing.
...
2. **If the user made substantive changes** (ideas rejected, angles replaced, categories changed):
   ...
   - If yes, save to `.Codex/skills/debrief/learnings/idea-sourcer/` with date, article reference, and lesson
