...
1. **Read learnings**: If `.Codex/skills/debrief/learnings/content-planner/` exists and has files, read the 5 most recent. Skip if empty.
...
3. Save to `.Codex/skills/debrief/learnings/content-planner/` with date, sprint reference, and lesson
