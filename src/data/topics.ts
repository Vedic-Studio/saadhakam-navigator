...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    summary:
      "The intellectual path of self-inquiry, using discernment to distinguish the real from the unreal.",
    content:
      "Jnana Yoga is the path of knowledge and wisdom. It involves intense self-inquiry (Atma-Vichara) and the study of sacred scriptures to directly experience the truth of one's identity. The core practice is Viveka (discernment) between the eternal soul (Atman) and the temporary material world.",
