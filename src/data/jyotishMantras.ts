...
export const jyotishMantras: Mantra[] = [
    {
        ...
        oneLineMeaning: "Om Hram Hrim Hraum Sah Suryaya Namah is the Navagraha beej mantra for Surya (the Sun), chanted on Sunday for clarity, vitality, and steady discipline.",
        ...
        answerBlock: {
            heading: "When Should You Chant the Surya Mantra?",
            body: "Chant Om Hram Hrim Hraum Sah Suryaya Namah on Sunday, ideally at sunrise or during morning sun practice, since Sunday (Ravivara) belongs to Surya in the vara cycle. In Jyotisha, Surya stands for vitality, clarity, confidence, and steady discipline, so the mantra is taken up to renew energy, order the day, and strengthen resolve. Face the morning light if you can, keep the breath natural, and use the japa counter below for 9, 27, or a full 108 repetitions.",
        },
        seoTitle: "Surya Mantra: Meaning, 108 Count & When to Chant",
        seoDescription: "The Sunday beej mantra for Surya (Sun). Word-by-word meaning, what it remedies, when to chant, and a 108 japa counter for clarity, vitality, and discipline.",
        ogTitle: "Surya Mantra: For Clarity, Energy, and Discipline",
        ogDescription: "Chant on Sunday morning, facing the light. Full Sanskrit, meaning, and method, 9, 27, or 108 times.",
    },
    {
        ...
        oneLineMeaning: "Om Shram Shrim Shraum Sah Chandraya Namah is the Navagraha beej mantra for Chandra (the Moon), chanted on Monday to calm the mind and steady the emotions.",
        tradition: ["Jyotisha", "Vedic"],
        deityFocus: "Chandra",
        ...
        seoTitle: "Chandra Mantra: Om Shram Shrim Shraum Sah Chandraya",
        seoDescription: "Monday Navagraha mantra for Chandra (Moon). Sanskrit, meaning, benefits, and how to chant for a calmer mind and steadier emotions.",
        ogTitle: "Chandra Mantra: For a Calm, Steady Mind",
        ogDescription: "Chant on Monday evening when the mind feels scattered. Full Sanskrit, meaning, and method.",
    },
    {
        ...
        oneLineMeaning: "Om Kram Krim Kraum Sah Bhaumaya Namah is the Navagraha beej mantra for Mangala (Mars), chanted on Tuesday for courage, discipline, and constructive energy.",
        ...
        seoTitle: "Mangala Mantra: Om Kram Krim Kraum Sah Bhaumaya",
        seoDescription: "Tuesday Navagraha mantra for Mangala (Mars). Sanskrit, meaning, benefits, and how to chant 9, 27, or 108 times for courage and clean energy.",
        ogTitle: "Mangala Mantra: For Courage and Clean Energy",
        ogDescription: "Chant on Tuesday morning to channel drive into disciplined action. Full Sanskrit, meaning, and method.",
    },
    {
        ...
        oneLineMeaning: "Om Bram Brim Braum Sah Budhaya Namah is the Navagraha beej mantra for Budha (Mercury), chanted on Wednesday for clearer speech, study, and discrimination.",
        tradition: ["Jyotisha", "Navagraha"],
        deityFocus: "Budha",
        ...
        answerBlock: {
            heading: "When Should You Chant the Budha Mantra?",
            body: "Chant Om Bram Brim Braum Sah Budhaya Namah on Wednesday, ideally in the morning before study, writing, teaching, or planning, since Wednesday (Budhavara) belongs to Budha in the vara cycle. In Jyotisha, Budha governs speech, intellect, analysis, and commerce, so the mantra is taken up to steady the voice, sharpen discrimination, and settle scattered thinking. Keep the pronunciation careful and unhurried, and use the japa counter below for 9, 27, or a full 108 repetitions.",
        },
        seoTitle: "Om Bram Brim Braum Sah Budhaya Namah: When to Chant",
        seoDescription: "The Wednesday beej mantra for Budha (Mercury). Word-by-word meaning, what it remedies, when to chant, and a 108 japa counter to keep your count.",
    ...
    },
    {
        ...
        oneLineMeaning: "Om Gram Grim Graum Sah Gurave Namah is the Navagraha beej mantra for Brihaspati (Jupiter), chanted on Thursday for wisdom, guidance, and ethical clarity.",
        tradition: ["Jyotisha", "Navagraha"],
        ...
        seoTitle: "Guru Mantra: Om Gram Grim Graum Sah Gurave Namah",
        seoDescription: "Thursday Navagraha mantra for Brihaspati (Jupiter). Sanskrit, meaning, benefits, and how to chant for wisdom, guidance, and good counsel.",
        ogTitle: "Guru Mantra: For Wisdom and Good Counsel",
        ogDescription: "Chant on Thursday morning before study or mentoring. Full Sanskrit, meaning, and method.",
    },
    {
        ...
        oneLineMeaning: "Om Dram Drim Draum Sah Shukraya Namah is the Navagraha beej mantra for Shukra (Venus), chanted on Friday for harmony, refinement, and relational balance.",
        tradition: ["Jyotisha", "Navagraha"],
        deityFocus: "Shukra",
        ...
        seoTitle: "Shukra Mantra: Om Dram Drim Draum Sah Shukraya",
        seoDescription: "Friday Navagraha mantra for Shukra (Venus). Sanskrit, meaning, benefits, and how to chant for harmony, relationships, and refinement.",
        ogTitle: "Shukra Mantra: For Harmony and Refinement",
        ogDescription: "Chant on Friday for relational grace and balance. Full Sanskrit, meaning, and method.",
    },
    {
        ...
        oneLineMeaning: "Om Pram Prim Praum Sah Shanaishcharaya Namah is the Navagraha beej mantra for Shani (Saturn), chanted on Saturday for discipline, humility, and patience.",
        tradition: ["Jyotisha", "Navagraha"],
        deityFocus: "Shani",
        ...
        seoTitle: "Shani Mantra: Om Pram Prim Praum Sah Shanaishcharaya",
        seoDescription: "Saturday Navagraha mantra for Shani (Saturn). Sanskrit, meaning, benefits, and how to chant 9, 27, or 108 times for discipline and patience.",
        ogTitle: "Shani Mantra: For Discipline and Patience",
        ogDescription: "Chant on Saturday to meet Shani as a teacher of maturity. Full Sanskrit, meaning, and method.",
    },
    {
        ...
        oneLineMeaning: "Om Bhram Bhrim Bhraum Sah Rahave Namah is the Navagraha beej mantra for Rahu, chanted for discernment and containment when intensity or obsession rises.",
        tradition: ["Jyotisha", "Navagraha"],
        deityFocus: "Rahu",
        ...
        seoTitle: "Rahu Mantra: Om Bhram Bhrim Bhraum Sah Rahave Namah",
        seoDescription: "Navagraha mantra for Rahu. Sanskrit, meaning, benefits, and how to chant 9, 27, or 108 times for discernment and steadier focus.",
        ogTitle: "Rahu Mantra: For Discernment and Focus",
        ogDescription: "Chant to steady appetite and anxiety without drama. Full Sanskrit, meaning, and grounded method.",
    },
    {
        ...
        oneLineMeaning: "Om Sram Srim Sraum Sah Ketave Namah is the Navagraha beej mantra for Ketu, chanted for detachment, simplification, and inward clarity in practice.",
        tradition: ["Jyotisha", "Navagraha"],
        deityFocus: "Ketu",
        ...
        seoTitle: "Ketu Mantra: Om Sram Srim Sraum Sah Ketave Namah",
        seoDescription: "Navagraha mantra for Ketu. Sanskrit, meaning, benefits, and how to chant 9, 27, or 108 times for detachment, clarity, and inner focus.",
        ogTitle: "Ketu Mantra: For Detachment and Inner Clarity",
        ogDescription: "Chant to support release and self-inquiry. Full Sanskrit, meaning, and method.",
    },
    {
