...
export const traditions: Tradition[] = [
  {
    ...
    coreOrientation:
      "Shiva as supreme consciousness, destroyer of ignorance, and the ultimate yogi",
    primaryPractices: [
      "Shiva puja",
      "Japa of Panchakshari",
      "Meditation",
      "Sacred ash (vibhuti)",
    ],
    tone: "contemplative",
  ...
  },
  {
    ...
    coreOrientation:
      "Shakti (divine power) as the supreme reality; the Goddess as mother, warrior, and wisdom",
    primaryPractices: [
      "Devi puja",
      "Mantra sadhana",
      "Yantra worship",
    ...
    whoItSuits:
      "Those drawn to divine feminine energy, seekers comfortable with paradox, and those attracted to transformative spiritual power.",
    howToStart:
      "Begin with simple Devi worship, learn a Shakti mantra, and observe Navaratri with devotion.",
  ...
  },
  {
    ...
    coreOrientation:
      "Vishnu as preserver and protector; loving relationship with God through bhakti",
    primaryPractices: [
      "Vishnu puja",
      "Nama japa",
      "Temple worship",
    ...
    whoItSuits:
      "Those who feel natural devotion, seekers wanting personal relationship with God, and those drawn to Krishna or Rama.",
    howToStart:
      "Read the Bhagavad Gita, practice japa of a Vishnu mantra, and explore kirtan and devotional singing.",
  ...
  },
  {
    ...
    coreOrientation:
      "All major deities are forms of one ultimate reality; freedom in worship",
    primaryPractices: [
      "Panchayatana puja",
      "Study of shastras",
      "Traditional rituals",
      "Personal ishta-devata",
    ],
    tone: "ritualistic",
    description:
  ...
  },
  {
    ...
    coreOrientation:
      "The body as temple; all experience as potentially liberating; integration not renunciation",
    primaryPractices: [
      "Mantra sadhana",
      "Kundalini practices",
      "Nyasa (sacred touch)",
    ...
    tone: "mystical",
    description:
      "Tantra represents esoteric traditions found across Shaiva, Shakta, and Buddhist contexts. It emphasizes the body as a vehicle for liberation, the transformation of desire, and the awakening of subtle energies.",
    keyIdeas: [
    ...
    whoItSuits:
      "Serious seekers with stable foundations, those drawn to energy practices, and practitioners ready for systematic, guided work.",
    howToStart:
      "Find a qualified teacher, develop stable meditation practice first, and approach with respect rather than sensationalism.",
  ...
  },
  {
    ...
    coreOrientation:
      "Pure love of God transcends caste, learning, and formal ritual",
    primaryPractices: ["Kirtan", "Nama japa", "Poetry and song", "Satsang"],
    tone: "devotional",
    description:
      "The Bhakti movements, arising especially in medieval India, democratized spirituality through emphasis on love, devotional poetry, and the salvific power of the divine name. Saints like Kabir, Mirabai, and Tukaram made the path accessible to all.",
    keyIdeas: [
    ...
    whoItSuits:
      "Emotional and heart-centered seekers, those who love music and poetry, and anyone seeking accessible, egalitarian spirituality.",
    howToStart:
      "Attend kirtan sessions, read poetry of the Bhakti saints, and practice simple devotional singing.",
  ...
  },
  {
    ...
    coreOrientation:
      "All reality is consciousness (Shiva) in dynamic creative expression (Shakti)",
    primaryPractices: [
      "Spanda meditation",
      "Recognition practices",
      "Mantra",
      "Study of pratyabhijna",
    ],
    tone: "mystical",
    description:
      "Kashmir Shaivism represents a sophisticated non-dual philosophy arising in Kashmir, teaching that consciousness (Shiva) continuously manifests as the universe through creative power (Shakti). It offers both profound philosophy and practical methods.",
    keyIdeas: [
    ...
    whoItSuits:
      "Philosophical seekers attracted to non-duality, those interested in consciousness studies, and practitioners wanting integration of philosophy and practice.",
    howToStart:
      "Study the Shiva Sutras, learn basic recognition practices, and find qualified teachers in this tradition.",
