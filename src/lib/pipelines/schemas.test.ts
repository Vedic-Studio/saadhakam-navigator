...
const validDetail = {
    ...
    description: "A beginner-friendly introduction to Vedanta.",
    reference_links: ["https://example.com/upanishads"],
    key_angles: ["lineage", "non-duality basics"],
    source_notes: "Anchor claims in primary texts where possible.",
