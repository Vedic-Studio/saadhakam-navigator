...
const PATH_META: Record<PathKey, {
  ...
  inquiry: {
    ...
    philosophy: 'Advaita Vedanta', philosophyLink: 'https://opensadhaka.com/advaita-vedanta-explained',
  ...
  devotion: {
    ...
    philosophy: 'Bhakti Vedanta', philosophyLink: 'https://opensadhaka.com/shaivism-vs-vaishnavism',
  ...
  ritual: {
    ...
    philosophy: 'Karma Yoga & Tantra', philosophyLink: 'https://opensadhaka.com/adi-shankaracharya-life-teachings',
  ...
  discipline: {
    ...
    philosophy: 'Samkhya-Yoga', philosophyLink: 'https://opensadhaka.com/yoga-sutras-complete-guide',
...
function email0(result: QuizResult): string {
  ...
  return wrap('Your Spiritual Path', 'opensadhaka.com \u00b7 Faith Finder', body,
    'https://opensadhaka.com/faith-finder', 'View Your Full Results \u2192');
}
...
function email1(result: QuizResult): string {
  ...
  return wrap('Day 1: Your First Practice', `${m.label} \u00b7 ${m.firstPractice}`, body,
    'https://opensadhaka.com/practical-spiritual-practices', 'Explore More Practices \u2192');
}
...
function email3(result: QuizResult): string {
  ...
  return wrap('Day 7: One Week In', 'Reflect, notice, and add a second practice', body,
    'https://opensadhaka.com/daily-spiritual-routine-beginners', 'Build Your Routine \u2192');
}
...
function email5(result: QuizResult): string {
  ...
  return wrap('Day 30: Your Path Continues', `${m.label} \u2014 what comes next`, body,
    'https://opensadhaka.com', 'Continue on opensadhaka.com \u2192');
}
