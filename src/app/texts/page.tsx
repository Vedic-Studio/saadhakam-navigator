...
export const metadata: Metadata = {
    ...
    keywords: ["vedas", "upanishads", "bhagavad gita", "sacred texts", "puranas", "agamas", "sanskrit texts"],
    alternates: { canonical: "https://opensadhaka.com/texts" },
    openGraph: {
        title: "Sacred Hindu Texts | Sadhaka",
        description: "Explore Vedas, Upanishads, Bhagavad Gita, and more sacred texts with translations.",
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                The Vedas, Upanishads, and Gita form the eternal foundation of Sanatan Dharma.
                                Each text is a doorway to a different facet of the infinite.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {texts.map((text) => (
                                <Card key={text.slug} className="bg-card border-border/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-primary/10 hover:shadow-lg">
                                    <CardContent className="p-6">
                                        <div className="flex items-start justify-between mb-3">
                                            <div>
                                                ...
                                                <div className="font-sanskrit text-primary text-lg mb-1">{text.sanskritTitle}</div>
                                                <h2 className="font-display text-xl font-semibold text-foreground">{text.title}</h2>
                                            </div>
