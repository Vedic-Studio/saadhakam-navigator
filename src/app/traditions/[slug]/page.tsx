...
export async function generateMetadata({
    ...
    return {
        ...
        keywords: [tradition.title.toLowerCase(), ...tradition.tags, "sanatan dharma", "spiritual tradition"],
...
export default async function TraditionDetailPage({
    ...
    const breadcrumbSchema = {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Traditions", item: "https://opensadhaka.com/traditions" },
            { "@type": "ListItem", position: 3, name: tradition.title, item: `https://opensadhaka.com/traditions/${slug}` },
        ],
    };
            ...
            <main className="pt-20">
                <section className="py-16 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto">
                        <nav aria-label="Breadcrumb" className="mb-6">
                            <Link href="/traditions" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                                <ArrowLeft className="w-4 h-4" />Back to Traditions
                            </Link>
                        </nav>
                        <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-4">{tradition.title}</h1>
                        <p className="text-xl text-muted-foreground mb-6">{tradition.summary}</p>
                ...
                <section className="py-8 px-4 sm:px-6 lg:px-8 pb-20">
                    <div className="max-w-4xl mx-auto grid gap-8">
                        ...
                        <Card className="bg-card border-border/50">
                            <CardContent className="p-6">
                                <h2 className="font-display text-xl font-semibold text-foreground mb-4">Key Ideas</h2>
                        ...
                        <Card className="bg-card border-border/50">
                            <CardContent className="p-6">
                                <h2 className="font-display text-xl font-semibold text-foreground mb-3">Primary Practices</h2>
                                <div className="flex flex-wrap gap-2">
                                    {tradition.primaryPractices.map((p) => (
                                        <span key={p} className="px-3 py-2 bg-muted rounded-lg text-sm text-foreground">{p}</span>
                                    ))}
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-card border-border/50">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h2 className="font-display text-xl font-semibold text-foreground">Who It Suits</h2>
                                </div>
                                <p className="text-muted-foreground leading-relaxed">{tradition.whoItSuits}</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-card border-border/50">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h2 className="font-display text-xl font-semibold text-foreground">How to Start</h2>
                                </div>
                                <p className="text-muted-foreground leading-relaxed">{tradition.howToStart}</p>
                            </CardContent>
                        </Card>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            <Link href="/traditions" className="flex-1">
                                <Button size="lg" variant="outline" className="w-full">Explore All Traditions</Button>
                            </Link>
                        </div>
                    </div>
                </section>
