        ...
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            ...
            <main className="flex-grow pt-24 pb-16">
                <div className="container-padding max-w-4xl mx-auto">
                    ...
                    <p className="text-lg text-muted-foreground mb-2">{mantra.devanagari ? `${mantra.devanagari} · ` : ""}{mantra.transliteration}</p>
                    ...
                    {related.length > 0 && (
                        <section>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {related.map((item) => (
                                    <Link key={item!.slug} href={`/mantras/${item!.slug}`} className="px-4 py-2 rounded-xl border border-border hover:border-orange-500/50">
                                        {item!.name}
                                    </Link>
                                ))}
                            </div>
