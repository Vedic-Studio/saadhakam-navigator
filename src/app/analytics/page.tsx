...
export default async function AnalyticsPage() {
    const [gscResult, ga4Result] = await Promise.allSettled([fetchGscDashboardData(), fetchGa4DashboardData()]);
    ...
    return <AnalyticsDashboard gscData={gscData} ga4Data={ga4Data} errors={errors} />;
}