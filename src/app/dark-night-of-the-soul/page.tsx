...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "Karma provides the framework: every action has consequences, and regret is the mind's attempt to retroactively alter what is unalterable. Regret is useful only for guiding future action; sustained as an identity ('I am someone who did that terrible thing'), it becomes self-punishment that creates new negative karma. The practice: fully acknowledge what was done, make amends where possible, learn what must be learned, and then genuinely release the identity-story that clings to the error. The error was an action; it is not you.",
    },
];
                ...
                <div className="container-padding max-w-4xl mx-auto">
                    ...
                    <div className="space-y-14">
                        ...
                        <section>
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                                Spiritual bypassing is seductive precisely because it uses genuine wisdom in service of avoidance. "It's all maya (illusion)" is true at the highest level of Vedantic analysis. But using it to avoid apologizing to a person you hurt is not Advaita — it is ego defense wearing Advaita's clothing.
                            </p>
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                The tradition's consistent teaching: you cannot skip stages. The path to non-duality runs <em>through</em> the human realm, not around it. Unresolved psychological material will continuously derail spiritual practice until it is met directly.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="space-y-5">
                                <div className="rounded-2xl border border-border/40 bg-card/30 p-6">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">The instinct to resolve the darkness as quickly as possible — through new spiritual practices, new teachers, new frameworks — is itself part of the ego's resistance. The dark night asks you to stop constructing, and simply be with what is. The witness behind the darkness is already present.</p>
                                </div>
                                <div className="rounded-2xl border border-border/40 bg-card/30 p-6">
                                    <h3 className="font-bold text-orange-400 mb-2">2. Distinguish Between the Darkness and Your Reaction to It</h3>
                                    <p className="text-muted-foreground leading-relaxed">There is the dark night itself — the dissolution of meaning. And there is your interpretation of the dark night — "something is terribly wrong," "I'm regressing," "God has abandoned me." The dissolution is the work happening. The interpretation is often additional suffering. A meditation practice helps separate the two.</p>
                                </div>
                                <div className="rounded-2xl border border-border/40 bg-card/30 p-6">
                                ...
                                <div className="rounded-2xl border border-border/40 bg-card/30 p-6">
                                    ...
                                    <p className="text-muted-foreground leading-relaxed">Regret is wishing you had today's understanding yesterday. It is useful for about 30 seconds — just long enough to extract the lesson. After that, it becomes a story you tell about who you are. The Gita's teaching on Karma applies directly: the action happened, the consequences are real, learn and move. Sustained self-punishment is ego, not ethics.</p>
                                </div>
                            </div>
