...
export default function BhagavadGitaChapter1Page() {
    return (
        <ArticleLayout meta={meta} pillarLabel="Sacred Texts" pillarHref="/sacred-texts-teachings">
            ...
            <p>
                <em>Dhritarashtra said: O Sanjaya, what did my sons and the sons of Pandu do after gathering on the sacred field of Kurukshetra, eager for battle?</em> (BG 1.1)
            </p>

            <h2>Arjuna Surveys the Battlefield</h2>
            <p>
            ...
            <p>
                The word for this vision — <em>seeing both armies as relatives</em> — is a profound literary moment. It is easy to fight enemies. It is entirely different to fight family.
            </p>

            <h2>The Collapse: Arjuna's Grief</h2>
            <p>
                Verses 28–47 record one of literature's most vivid depictions of despair. Arjuna's body fails him:
            </p>
            <p>
                <em>My limbs fail and my mouth is parched, my body quivers and my hair stands on end. My bow slips from my hand, and my skin burns all over; I am unable to stand, and it seems to me that my mind is reeling.</em> (BG 1.29-30)
            </p>
            <p>
            ...
            <ul>
                <li>Killing kin is the greatest sin (1.36-37)</li>
                <li>The death of family destroys its spiritual traditions (1.39-44)</li>
                <li>Social chaos follows (1.40-43)</li>
                <li>It would be better to die ourselves than to kill them (1.45-46)</li>
            </ul>
            <p>
            ...
            <h2>Why This Chapter is Called "Yoga"</h2>
            <p>
                The title Arjuna <em>Vishada</em> Yoga is often translated as "The Yoga of Arjuna's Dejection." This puzzles Western readers: how is grief a yoga?
            </p>
            <p>
            ...
            <p>
                Chapter 1 closes with Arjuna slumped in his chariot, bow fallen, overwhelmed with grief, declaring he will not fight. <em>Having spoken thus in the middle of the battlefield, Arjuna sat down on the seat of the chariot, casting aside his bow and arrows, his mind overwhelmed with sorrow.</em> (BG 1.47)
            </p>
            <p>
