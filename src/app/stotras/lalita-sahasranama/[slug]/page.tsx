...
import { lalitaSahasranamaNames, getLalitaSahasranamaNameBySlug } from "@/data/lalitaSahasranama";

export function generateStaticParams() {
  return lalitaSahasranamaNames.map((n) => ({ slug: n.slug }));
}

export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  const name = getLalitaSahasranamaNameBySlug(params.slug);
