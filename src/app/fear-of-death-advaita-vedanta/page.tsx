...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "Yes, but only if it becomes a living practice rather than an intellectual exercise. Reading about non-duality helps intellectually. But the practice that actually reduces the fear of death is daily meditation — 'dying' to the ego-sense every day in a controlled, voluntary way. Each meditation session is a micro-rehearsal: you release the grip of the day's identity and rest in pure awareness. Over time, this makes the larger release (physical death) far less terrifying.",
    },
];
                    ...
                    <div className="space-y-14">
                        <section>
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                                The Taittiriya Upanishad contains one of the most radical statements in human thought: <em>"From fear of Brahman, the wind blows. From fear of Brahman, the sun rises. From fear of Brahman, fire burns."</em> Fear, at its deepest level, is not a defect to be eliminated — it is the structural energy of a finite thing in the presence of the infinite.
                            </p>
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                                But the fear of death as most of us experience it is a different and more limited thing: it is the ego's terror of its own non-existence. The ego is a construction — a bundle of memories, habits, preferences, and social roles that forms a coherent sense of "me." This construction knows, at some level, that it is temporary. And that knowledge is the source of an ambient anxiety that colors much of human experience.
                            </p>
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                Advaita's answer is not to reassure the ego that it will persist. It is to investigate whether the ego was ever what you actually are.
                            </p>
                        </section>
                        ...
                        <section className="bg-muted/30 rounded-3xl p-10 border border-border/50">
                            ...
                            <ul className="space-y-5 mb-8">
                                ...
                                <li className="flex gap-4">
                                    <span className="text-orange-500 font-black text-2xl leading-none mt-0.5">◆</span>
                                    <p className="text-muted-foreground leading-relaxed">But from the ocean's perspective, nothing died. The water that was the wave is still water. It simply returned to the undifferentiated mass from which it arose.</p>
                                </li>
                                <li className="flex gap-4">
                                    <span className="text-orange-500 font-black text-2xl leading-none mt-0.5">◆</span>
                                    <p className="text-muted-foreground leading-relaxed">Advaita says: you have been identifying with the wave (the individual ego-body-mind). But you are actually the ocean (Brahman, infinite consciousness). The wave was a temporary expression of the ocean, not a separate entity.</p>
                                </li>
                            </ul>
                            <p className="text-base text-muted-foreground leading-relaxed italic border-l-4 border-orange-500/30 pl-6">
                                The pot and the space: when a clay pot is made, the space inside it seems separate from the space outside. When the pot breaks, the "inner space" and "outer space" merge — but no space was destroyed. Only the pot (the boundary, the ego) dissolved. This is the Ghata-Akasha analogy from the Upanishads. You are the space, not the pot.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                                The second chapter of the Bhagavad Gita is the most sustained philosophical treatment of death in world literature. Krishna's opening salvo to Arjuna — who is paralyzed with grief at the prospect of his teachers and relatives dying in battle — is not condolence. It is ontology:
                            </p>
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                                Krishna then offers the clothes analogy (2.22): just as a person discards worn-out garments and takes new ones, the soul discards worn-out bodies and takes new ones. Death is not destruction — it is a change of clothes.
                            </p>
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                This is not offered as a comfort to avoid grief — Krishna explicitly tells Arjuna that grief over what is inevitable is a sign of confusion (avidya), not sensitivity. The goal is not to feel less but to see more clearly.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                                What Vedanta questions is the additional layer of suffering: the belief that the person is <em>permanently and completely gone</em> — that the consciousness that was them has been utterly annihilated and can never be known again. This belief — that death equals total, permanent non-existence — is the philosophical claim that creates the particular anguish of bereavement.
                            </p>
                            <p className="text-xl text-muted-foreground leading-relaxed">
                                The Vedantic counter is not sentimental: it is the claim that consciousness itself — the aware, experiencing presence that was your loved one — cannot be created or destroyed. It arose from Brahman. It returns to Brahman. Brahman is what you are. In the deepest sense, the separation is the illusion.
                            </p>
                        </section>
