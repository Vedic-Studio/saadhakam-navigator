...
export function ConversionSectionVariantD() {
    return (
        <section className="relative py-32 overflow-hidden bg-background">
            ...
            <div className="absolute top-1/2 right-10 w-64 h-64 bg-violet-900/10 rounded-full blur-[80px]" />
            ...
            <div className="container-padding mx-auto max-w-4xl relative z-10 text-center">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
                    ...
                    Connect with the wisdom of enlightened masters and accelerate your spiritual journey.
                </p>

                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <Link to="/pathfinder">
                        <Button size="lg" className="h-16 px-10 rounded-full text-lg bg-violet-600 text-violet-50 hover:bg-violet-700 shadow-2xl shadow-violet-900/20 hover:scale-105 transition-transform duration-300">
                ...
                {/* Guru Guidance Trust Indicators */}
                <div className="mt-12 flex flex-wrap items-center justify-center gap-8">
                    <div className="flex items-center gap-3">
                        <Star className="w-6 h-6 text-violet-400" />
                        <span className="text-sm font-medium text-violet-200">Master Guidance</span>
                    </div>
                    <div className="w-px h-6 bg-white/10 hidden sm:block" />
                    <div className="flex items-center gap-3">
                        <span className="text-xl">🧘</span>
                        <span className="text-sm font-medium text-violet-200">Lineage Wisdom</span>
                    </div>
                    <div className="w-px h-6 bg-white/10 hidden sm:block" />
                    <div className="flex items-center gap-3">
                        <span className="text-xl">🌟</span>
                        <span className="text-sm font-medium text-violet-200">Divine Transmission</span>
                    </div>
                </div>
            </div>
        </section>
