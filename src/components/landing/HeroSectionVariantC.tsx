...
export function HeroSectionVariantC() {
    return (
        <section className="relative min-h-screen flex items-center bg-background overflow-hidden pt-20">
            {/* Background gradients */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-950/40 via-background to-background" />
            ...
            <div className="container-padding relative z-10 w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center py-12">
                ...
                <div className="space-y-8 text-center lg:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md animate-fade-in">
                        ...
                        <span className="text-xs font-medium text-emerald-200 uppercase tracking-widest">Awaken the Guru Within</span>
                    </div>
                    ...
                    <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-[1.1] tracking-tight animate-fade-up">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 to-teal-400">Awaken the Guru Within</span>
                    </h1>
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-up" style={{ animationDelay: "0.2s" }}>
                        The ultimate teacher is already within you. Sadhaka provides the tools and guidance to discover your own inner wisdom and become your own guru.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4 animate-fade-up" style={{ animationDelay: "0.4s" }}>
                        <Link href="/faith-finder">
                            <Button size="lg" className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white border-0 h-14 px-8 rounded-full text-lg font-medium shadow-lg shadow-emerald-900/20 transition-all hover:scale-105">
                    ...
                    <div className="pt-6 flex flex-wrap items-center justify-center lg:justify-start gap-6 opacity-60 animate-fade-in" style={{ animationDelay: "0.6s" }}>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium uppercase tracking-wider">Inner Wisdom</span>
                        </div>
                        <div className="w-px h-6 bg-white/10 hidden sm:block" />
                        <div className="flex items-center gap-2">
                            <span className="text-xl">🧠</span>
                            <span className="text-sm font-medium uppercase tracking-wider">Self-Realization</span>
                        </div>
                        <div className="w-px h-6 bg-white/10 hidden sm:block" />
                        <div className="flex items-center gap-2">
                            <span className="text-xl">🔥</span>
                            <span className="text-sm font-medium uppercase tracking-wider">Inner Power</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative hidden lg:block animate-fade-up" style={{ animationDelay: "0.3s" }}>
                    ...
                    <div className="relative rounded-3xl overflow-hidden aspect-[4/5] shadow-2xl border border-white/10">
                        <img
                            src="/assets/generated/media__1770391240351.png"
                            alt="Self-Empowerment Visualization"
                        ...
                        <div className="absolute bottom-6 left-6 right-6 glass-card rounded-2xl p-5 border border-white/10 bg-black/60 backdrop-blur-xl animate-float">
                            ...
                            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 p-[2px]">
                            ...
                            <div className="space-y-3">
                                <div className="bg-white/5 text-white rounded-xl rounded-tl-sm py-3 px-4 border border-white/5">
                                    <p className="text-xs text-emerald-300/80 mb-1 font-sanskrit">आत्मनो मोक्षार्थं जगत्क्रिया</p>
                                    <p className="text-sm leading-relaxed opacity-90">
                                        "Work in the world for your own liberation. The path to freedom is through self-discovery and self-mastery."
                                    </p>
                                    <p className="text-xs text-muted-foreground mt-2">— Inner Wisdom</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 flex items-center gap-2">
                                <div className="flex-1 bg-white/5 rounded-full py-2.5 px-4 text-sm text-muted-foreground border border-white/5">
                                    Ask about self-realization or inner wisdom...
                                </div>
                                <Button size="icon" className="rounded-full bg-emerald-600 hover:bg-emerald-700 shrink-0">
                    ...
                    {/* Background glow */}
                    <div className="absolute inset-0 bg-emerald-500/10 blur-[80px] -z-10 translate-y-8" />
                </div>
