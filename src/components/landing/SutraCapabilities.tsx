...
// Separate mockup content components to avoid re-renders
const StudyMockup = () => (
            ...
            <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
                <div className="container-padding mx-auto w-full max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-24 items-center h-full py-20">
                            ...
                            {CAPABILITIES.map((cap, index) => {
                                ...
                                return (
                                    <div
                                        key={cap.id}
                                        className={cn(
                                            "flex items-center gap-6 relative z-10 transition-all duration-300 cursor-pointer",
                                            isActive ? "opacity-100 translate-x-2" : "opacity-40 hover:opacity-60"
                                        )}
                                    >
                                        {/* Number Circle */}
                                        <div className={cn(
                    ...
                    <div className="bg-card/20 border border-white/5 rounded-[2.5rem] p-4 h-[600px] w-full max-w-md mx-auto shadow-2xl relative overflow-hidden backdrop-blur-sm">
                        ...
                        {/* Dynamic Content - Show all, but only active is visible */}
