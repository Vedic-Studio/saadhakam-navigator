...
export function HeroSectionVariantF() {
    return (
        <section className="relative min-h-screen flex items-center bg-background overflow-hidden pt-20">
            {/* Background gradients */}
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-orange-950/40 via-background to-background" />
            ...
            <div className="container-padding relative z-10 w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center py-12">
                ...
                <div className="space-y-8 text-center lg:text-left">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md animate-fade-in">
                        ...
                        <span className="text-xs font-medium text-orange-200 uppercase tracking-widest">Unlock Potential</span>
                    </div>
                    ...
                    <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-[1.1] tracking-tight animate-fade-up">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-200 to-red-400">Unlock Your Dormant Potential</span>
                    </h1>
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-up" style={{ animationDelay: "0.2s" }}>
                        Tap into the extraordinary powers of consciousness that lie dormant within you. The ancient Rishis discovered methods to unlock human potential beyond ordinary limits.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4 animate-fade-up" style={{ animationDelay: "0.4s" }}>
                        <Link to="/pathfinder">
                            <Button size="lg" className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white border-0 h-14 px-8 rounded-full text-lg font-medium shadow-lg shadow-orange-900/20 transition-all hover:scale-105">
                                Unlock Your Power
                    ...
                    <div className="pt-6 flex flex-wrap items-center justify-center lg:justify-start gap-6 opacity-60 animate-fade-in" style={{ animationDelay: "0.6s" }}>
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium uppercase tracking-wider">Extraordinary Power</span>
                        </div>
                        <div className="w-px h-6 bg-white/10 hidden sm:block" />
                        <div className="flex items-center gap-2">
                            <span className="text-xl">🔥</span>
                            <span className="text-sm font-medium uppercase tracking-wider">Consciousness Expansion</span>
                        </div>
                        <div className="w-px h-6 bg-white/10 hidden sm:block" />
                        <div className="flex items-center gap-2">
                            <span className="text-xl">🚀</span>
                            <span className="text-sm font-medium uppercase tracking-wider">Human Potential</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative hidden lg:block animate-fade-up" style={{ animationDelay: "0.3s" }}>
                    ...
                    <div className="relative rounded-3xl overflow-hidden aspect-[4/5] shadow-2xl border border-white/10">
                        <img
                            ...
                            alt="Power Potential Visualization"
                        ...
                        <div className="absolute bottom-6 left-6 right-6 glass-card rounded-2xl p-5 border border-white/10 bg-black/60 backdrop-blur-xl animate-float">
                            ...
                            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-white/10">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-red-600 p-[2px]">
                            ...
                            <div className="space-y-3">
                                <div className="bg-white/5 text-white rounded-xl rounded-tl-sm py-3 px-4 border border-white/5">
                                    <p className="text-xs text-orange-300/80 mb-1 font-sanskrit">बलवान् भवतु</p>
                                    <p className="text-sm leading-relaxed opacity-90">
                                        "May you become powerful. The ancient texts describe extraordinary abilities that can be developed through dedicated practice and proper guidance."
                                    </p>
                                    <p className="text-xs text-muted-foreground mt-2">— Power Wisdom</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 flex items-center gap-2">
                                <div className="flex-1 bg-white/5 rounded-full py-2.5 px-4 text-sm text-muted-foreground border border-white/5">
                                    Ask about unlocking human potential or extraordinary powers...
                                </div>
