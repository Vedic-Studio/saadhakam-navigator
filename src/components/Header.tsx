  ...
  { type: "link", item: { label: "Panchang", href: "/panchang" } },
  {
    ...
    group: {
      ...
      items: [
        ...
        { label: "Temples Destroyed (Medieval India)", href: "/temples-destroyed-medieval-india", description: "The documented record from Muslim chronicles, mosque inscriptions, and ASI reports." },
        { label: "Aurangzeb's Destructions", href: "/aurangzeb-temples-destroyed", description: "Mughal demolitions from Kashi to Pandharpur via the Maasir-i-Alamgiri." },
        { label: "Mahmud of Ghazni's Raids", href: "/mahmud-of-ghazni-temples-destroyed", description: "Somnath 1026 and the seventeen Ghaznavid campaigns in Utbi and al-Biruni." },
        { label: "Sikandar Butshikan's Kashmir", href: "/sikandar-butshikan-kashmir-temples", description: "Martand and the conversion of the Kashmir Valley, c.1389–1413." },
        { label: "Case: Somnath 1026", href: "/somnath-destruction", description: "Mahmud of Ghazni's January 1026 raid; Utbi, al-Biruni, and Minhaj-us-Siraj on the record." },
        { label: "Case: Kashi Vishwanath 1669", href: "/kashi-vishwanath-aurangzeb", description: "Aurangzeb's firman, the September demolition entry, the Gyanvapi mosque on the footprint." },
        { label: "Case: Keshavdev Mathura 1670", href: "/keshavdev-mathura", description: "The four-element entry: demolition, mosque, idol burial at Agra, and Mathura renamed." },
        { label: "Case: Martand Sun Temple", href: "/martand-sun-temple", description: "Lalitaditya's 8th-century Surya temple, dismantled c. 1400 under Sikandar Butshikan." },
